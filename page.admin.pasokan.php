<h1>Data Permintaan Kabupaten</h1><hr>


<?php
if(getPageSub()=='ubah' || getPageSub()=='hapus' || getPageSub()=='tambah') {
  ?><a href="?halaman=pasokan" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Kembali ke tabel data</a><?php
} else if(getPageSub()!='tambah') {
  ?><a href="?halaman=pasokan&aksi=tambah" class="btn btn-primary"><i class="fa fa-plus"></i> Input Data Permintaan</a><br>
...
switch(getPageSub()) {
  case 'tambah' :
    if(isset($_POST['input_tambah'])) {
        ...
        $nop      = $_POST['input_nop'];
        $des      = $_POST['input_des'];
        $string   = "INSERT INTO `pasokan` ( `nama_kab`,`tahun`,`jan`,`feb`,`mar`,`apr`,`mei`,`jun`,`jul`,`agu`,`sep`,`okt`,`nov`,`des` )
		                  VALUE ( '$nama','$tahun','$jan','$feb','$mar','$apr','$mei','$jun','$jul','$agu','$sep','$okt','$nop','$des' )";
        $q          = $koneksi->query($string);
        if ($q ) {
            header("Location: index.php?halaman=pasokan");
        } else {
    ...
    <div class="row">
      <div class="col-md-6">  
        <div class="form-group">
          ...
          <input type="text" name="input_jan" class="form-control" placeholder="masukan jumlah.." autocomplete="off" value="<?php echo (isset($_POST['input_jan']))?$_POST['input_jan']:'' ?>" />
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-6"> 
        <div class="form-group">
          ...
          <input type="text" name="input_feb" class="form-control" placeholder="masukan jumlah.." autocomplete="off" value="<?php echo (isset($_POST['input_feb']))?$_POST['input_feb']:'' ?>" />
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-6"> 
        <div class="form-group">
          ...
          <input type="text" name="input_mar" class="form-control" placeholder="masukan jumlah.." autocomplete="off" value="<?php echo (isset($_POST['input_mar']))?$_POST['input_mar']:'' ?>" />
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-6"> 
        <div class="form-group">
          ...
          <input type="text" name="input_apr" class="form-control" placeholder="masukan jumlah.." autocomplete="off" value="<?php echo (isset($_POST['input_apr']))?$_POST['input_apr']:'' ?>" />
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-6"> 
        <div class="form-group">
          ...
          <input type="text" name="input_mei" class="form-control" placeholder="masukan jumlah.." autocomplete="off" value="<?php echo (isset($_POST['input_mei']))?$_POST['input_mei']:'' ?>" />
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-6"> 
        <div class="form-group">
          ...
          <input type="text" name="input_jun" class="form-control" placeholder="masukan jumlah.." autocomplete="off" value="<?php echo (isset($_POST['input_jun']))?$_POST['input_jun']:'' ?>" />
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-6"> 
        <div class="form-group">
          ...
          <input type="text" name="input_jul" class="form-control" placeholder="masukan jumlah.." autocomplete="off" value="<?php echo (isset($_POST['input_jul']))?$_POST['input_jul']:'' ?>" />
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-6"> 
        <div class="form-group">
          ...
          <input type="text" name="input_agu" class="form-control" placeholder="masukan jumlah.." autocomplete="off" value="<?php echo (isset($_POST['input_agu']))?$_POST['input_agu']:'' ?>" />
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-6"> 
        <div class="form-group">
          ...
          <input type="text" name="input_sep" class="form-control" placeholder="masukan jumlah.." autocomplete="off" value="<?php echo (isset($_POST['input_sep']))?$_POST['input_sep']:'' ?>" />
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-6"> 
        <div class="form-group">
          ...
          <input type="text" name="input_okt" class="form-control" placeholder="masukan jumlah" autocomplete="off" value="<?php echo (isset($_POST['input_okt']))?$_POST['input_okt']:'' ?>" />
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-6"> 
        <div class="form-group">
          ...
          <input type="text" name="input_nop" class="form-control" placeholder="masukan jumlah.." autocomplete="off" value="<?php echo (isset($_POST['input_nop']))?$_POST['input_nop']:'' ?>" />
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-6"> 
        <div class="form-group">
          ...
          <input type="text" name="input_des" class="form-control" placeholder="masukan jumlah.." autocomplete="off" value="<?php echo (isset($_POST['input_des']))?$_POST['input_des']:'' ?>" />
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-6"> 
        <div class="form-group">
          <button type="submit" name="input_tambah" class="btn btn-lg btn-success" value="SIMPAN"><i class="fa fa-save"></i> Simpan</button>
        </div>
      </div>
    </div>
    </form>
	...
	case 'ubah'		:
      if(isset($_POST['input_ubah'])) {
          ...
          $des    = $_POST['input_des'];
          $id       = getID();
          $string   = "UPDATE `pasokan` SET `tahun`='$tahun',`nama_kab`='$nama', `jan`='$jan', `feb`='$feb', `mar`='$mar', `apr`='$apr', `mei`='$mei',`jun`='$jun',
      ...
      $string       = "SELECT * FROM `pasokan` WHERE `id_pasokan`='".getID()."'";
      $q            = $koneksi->query($string);
      if ($q && $q->rowCount () > 0) {
      ...
      <div class="form-group">
          <button type="submit" name="input_ubah" class="btn btn-lg btn-info" value="UBAH DATA"><i class="fa fa-save"></i> Simpan</button>
      </div>
      </form>
      <?php
      } else {
  ...
  case 'hapus'    :
    if(isset($_POST['input_hapus'])) {
        $id       = getID();
        $string   = "DELETE FROM `pasokan` WHERE `id_pasokan`='$id'";
        $q          = $koneksi->query($string);
        if ($q ) {
    ...
    <div class="form-group">
        <a href="?halaman=pasokan" class="form-control center" style="text-align:center">Tidak</a>
    </div>
    </form>
    <?php
    } else {
      ...
      <div class="table-responsive">
        ...
        ?>
            <tr>
                ...
                <td>
                <center>
                	<a href="?halaman=pasokan&aksi=ubah&id=<?php echo $d[0] ?>" class=""><button type="button" class="btn btn-info"><i class="fa fa-pencil"></i></button>
                  <a href="?halaman=pasokan&aksi=hapus&id=<?php echo $d[0] ?>" class=""><button type="button" class="btn btn-danger"><i class="fa fa-trash"></i></button>
                </center></td>
            </tr>
		    <?php
        }
